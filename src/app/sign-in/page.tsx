  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center p-4 overflow-hidden">
      <motion.div
        ...
        style={{ backgroundImage: 'url("/bgImgBlur.wp2")' }}
        initial={{ opacity: 1 }}
        animate={{ opacity: backgroundLoaded ? 0 : 1 }}
                      ...
                      <Clerk.Field name="identifier" className="space-y-2">
                        ...
                        <div className="relative">
                          <Clerk.Input
                            ...
                            className="block w-full px-4 py-3 bg-white/10 text-white placeholder-white/50 rounded-xl focus:ring-2 focus:ring-white/50 focus:outline-none transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
