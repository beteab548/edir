/*
  ...
  - You are about to drop the column `type_id` on the `Contribution` table. All the data in the column will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "Contribution" DROP CONSTRAINT "Contribution_type_id_fkey";

-- AlterTable
ALTER TABLE "Contribution" DROP COLUMN "type_id",
ADD COLUMN     "contribution_type_id" INTEGER NOT NULL;
